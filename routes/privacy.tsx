		...
		<>
			...
			<div class='flex flex-col items-center min-h-screen h-full w-full background-animate text-white py-16'>
				...
				<div class='flex items-center justify-center w-full max-w-screen-md mx-auto px-4 py-8 gap-8'>
					<div class='flex flex-col p-8 rounded-2xl shadow-xl w-full bg-gradient-to-br from-gray-800 to-gray-700 border border-gray-600'>
						...
						<a href='/images/architecture.png' class='text-blue-400 underline'>
						...
						<p class='text-gray-300 mb-4'>
							VailNote is design using a multi-layer authentification system. Not even our team cannot access your note
							contents. All encryption and decryption happens on your device.
						</p>
